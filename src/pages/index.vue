      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-6 py-2">
              <h6>경력: <span class="text-secondary">10 Years</span></h6>
            </div>
            <div class="col-sm-6 py-2">
              <h6>번호: <span class="text-secondary">010-3143-7890</span></h6>
            </div>
            <div class="col-sm-6 py-2">
              <h6>
                이메일: <span class="text-secondary">soslth@naver.com</span>
              </h6>
            </div>
            <div class="col-sm-6 py-2">
              <h6>
                주소:
                <span class="text-secondary">서울시 광진구</span>
              </h6>
            </div>
            <div class="col-sm-6 py-2">
        ...
        <div class="col-lg-6">
          ...
          <div class="border-left border-primary pt-2 pl-4 ml-2">
            <div class="position-relative mb-4">
              ...
              ></i>
              <h5 class="font-weight-bold mb-1">석사</h5>
              <p class="mb-2">
                <strong>연세대학교</strong> |
            ...
            <div class="position-relative mb-4">
              <i
                ...
                style="top: 2px; left: -32px"
              ></i>
              <h5 class="font-weight-bold mb-1">학사</h5>
              <p class="mb-2">
                <strong>상명대학교</strong> |
            ...
            <div class="position-relative mb-4">
              <i
                ...
                style="top: 2px; left: -32px"
              ></i>
              <h5 class="font-weight-bold mb-1">고등학교</h5>
              <p class="mb-2">
          ...
          <div class="border-left border-primary pt-2 pl-4 ml-2">
            <div class="position-relative mb-4">
              <i
                ...
                style="top: 2px; left: -32px"
              ></i>
              <h5 class="font-weight-bold mb-1">진학사</h5>
              <p class="mb-2">
            ...
            <div class="position-relative mb-4">
              <i
                ...
                style="top: 2px; left: -32px"
              ></i>
              <h5 class="font-weight-bold mb-1">영우디에스피</h5>
              <p class="mb-2">
